...
import { Box, Grid, Stack, Switch, Tooltip, Typography, type SelectChangeEvent } from "@mui/material";
...
const UserToolbar = ({ filters, onFilterChange }: ToolbarProps) => {
    ...
    <ToolbarLayout>
      <Grid size={{ xs: 12, sm: 4, md: 3 }}>
        <Stack>
          ...
          <SearchBar  onSearch={(value: string) => onFilterChange("search", value)} />
        </Stack>
      </Grid>
