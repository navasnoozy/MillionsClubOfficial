...
import { Box, debounce, Grid, Stack, Switch, Tooltip, Typography, type SelectChangeEvent } from "@mui/material";
...
const ProductToolbar = ({ filters, onFilterChange }: ToolbarProps) => {
